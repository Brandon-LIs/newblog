...
function generateShareImage(memo: Memo): Promise<HTMLCanvasElement> {
  ...
  const avatar = memo.creator?.avatarUrl || 'https://blogimg.tos-cn-shanghai.volces.com/img/icon.jpg';
        ...
        <div className={styles.sidebar}>
          <div className={styles.sidebarInner}>
            <div className={styles.sidebarAvatar}>
              <img src="https://blogimg.tos-cn-shanghai.volces.com/img/icon.jpg" alt="Brandon" width={80} height={80} />
            </div>
