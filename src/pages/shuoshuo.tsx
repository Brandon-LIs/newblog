...
function generateShareImage(memo: Memo): Promise<HTMLCanvasElement> {
  ...
  const avatar = memo.creator?.avatarUrl || 'https://jsd.onmicrosoft.cn/npm/br-blog@1.0.3/img/icon.jpg';
        ...
        <div className={styles.sidebar}>
          <div className={styles.sidebarInner}>
            <div className={styles.sidebarAvatar}>
              <img src="https://jsd.onmicrosoft.cn/npm/br-blog@1.0.3/img/icon.jpg" alt="Brandon" width={80} height={80} />
            </div>
