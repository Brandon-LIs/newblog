...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        'relative z-20 h-full w-full overflow-hidden rounded-xl border border-border bg-background p-4 transition-colors duration-300 group-hover:border-[var(--ifm-color-primary-light)]',
        className,
      )}>
